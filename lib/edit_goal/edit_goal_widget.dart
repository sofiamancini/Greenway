...
class EditGoalWidget extends StatefulWidget {
  ...
  final DocumentReference? goalsDocument;
...
class _EditGoalWidgetState extends State<EditGoalWidget> {
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      logFirebaseEvent('EDIT_GOAL_PAGE_EditGoal_ON_INIT_STATE');
      logFirebaseEvent('EditGoal_update_page_state');
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<List<GoalsRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<GoalsRecord> editGoalGoalsRecordList = snapshot.data!;
        // Return an empty Container when the item does not exist.
        if (snapshot.data!.isEmpty) {
          return Container();
        }
        final editGoalGoalsRecord = editGoalGoalsRecordList.isNotEmpty
            ? editGoalGoalsRecordList.first
            : null;
                              ...
                              child: Row(
                                ...
                                children: [
                                  FlutterFlowIconButton(
                                    ...
                                    onPressed: () async {
                                      logFirebaseEvent(
                                          'EDIT_GOAL_PAGE_BackButton_ON_TAP');
                                      logFirebaseEvent(
                                ...
                                children: [
                                  ...
                                  Container(
                                    ...
                                    child: FlutterFlowDropDown<String>(
                                      controller:
                                          _model.carbonGoalValueController ??=
                                  ...
                                  Container(
                                    ...
                                    child: FFButtonWidget(
                                      onPressed: () async {
                                        logFirebaseEvent(
                                            'EDIT_GOAL_PAGE_EditButton_ON_TAP');
                                        logFirebaseEvent(
                                            'EditButton_navigate_to');
                                  ...
                                  Container(
                                    ...
                                    child: FFButtonWidget(
                                      onPressed: () async {
                                        logFirebaseEvent(
                                            'EDIT_GOAL_PAGE_DeleteButton_ON_TAP');
                                        logFirebaseEvent(
                                        ...
                                        await widget.goalsDocument!.delete();
                                      },
                                      text: 'Delete',
                                      options: FFButtonOptions(
                                        width: 100.0,
