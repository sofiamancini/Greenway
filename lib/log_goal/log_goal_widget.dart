...
class LogGoalWidget extends StatefulWidget {
  const LogGoalWidget({super.key});

  @override
  State<LogGoalWidget> createState() => _LogGoalWidgetState();
}

class _LogGoalWidgetState extends State<LogGoalWidget> {
  late LogGoalModel _model;
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    InkWell(
                                      ...
                                      onTap: () async {
                                        logFirebaseEvent(
                                            'LOG_GOAL_PAGE_DatePicker_ON_TAP');
                                        logFirebaseEvent(
